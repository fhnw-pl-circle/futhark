...
# install python 3
RUN apt-get update && apt-get install -y python3 python3-pip libjpeg-dev zlib1g-dev && apt-get clean && rm -rf /var/lib/apt/lists/* && pip3 install --upgrade pip && python3 -m pip install numpy ipython ipykernel matplotlib numba
